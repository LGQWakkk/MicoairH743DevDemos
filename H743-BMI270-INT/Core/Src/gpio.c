...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, LED_G_Pin|LED_R_Pin|LED_B_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, BMI088_ACCEL_CS_Pin|BMI088_GYRO_CS_Pin, GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = BMI088_ACCEL_DR_Pin|BMI088_GYRO_DR_Pin;
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = SPL06_DR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(SPL06_DR_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = BMI270_DR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(BMI270_DR_GPIO_Port, &GPIO_InitStruct);
